...
export default class DocsMenu extends React.Component {
        render() {
                ...
                return ( <
                        ...
                        className = "docs-nav" >
                        <
                        div id = "docs-nav-inside"
                        className = "docs-nav-inside sticky" >
                        <
                        button id = "docs-nav-toggle"
                        className = "docs-nav-toggle" > Navigate Docs < span className = "icon-angle-right"
                        ...
                        <
                        li className = {
                            classNames('docs-menu-item', {
                                'current': _.get(page, 'url', null) === _.get(root_page, 'url', null)
                            })
                        } >
                        <
                        Link to = {
                            withPrefix(_.get(root_page, 'url', null))
                        } > {
                        ...
                        /li> {
                            _.map(_.get(site, 'data.doc_sections.sections', null), (section, section_idx) => {
                                    ...
                                    return ( < React.Fragment key = {
                                            ...
                                            <
                                            Link to = {
                                                withPrefix(_.get(section_page, 'url', null))
                                            } > {
